...
This book is part of [the *geocompx* series](https://geocompx.org/), following the popular R [@lovelace2025geocomputation] and Python [@dorman2025geocomputation] editions. It mimics the structure and partially reuses text from these editions.
